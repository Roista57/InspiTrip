        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
                    <img src="https://edu.ssafy.com/asset/images/header-logo.jpg" alt="mdo" />
                </a>

                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li>
                        <router-link :to="{ name: 'main' }" class="nav-link px-2 link-secondary">HOME</router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'map' }" class="nav-link px-2 link-body-emphasis">MAP</router-link>
                    </li>
                    <li>
                ...
                <div class="dropdown text-end">
                    ...
                    <ul v-if="member.isLogin" class="dropdown-menu text-small">
                        ...
                        <li>
                            <router-link :to="{ name: 'member-logout' }" class="dropdown-item">로그아웃</router-link>
                        </li>
                    </ul>
                    <ul v-if="!member.isLogin" class="dropdown-menu text-small">
                        <li>
                            <router-link :to="{ name: 'member-regist' }" class="dropdown-item">회원가입</router-link>
                        </li>
                        <li>
