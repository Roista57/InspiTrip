  ...
  <div class="container">
    ...
    <form @submit.prevent="registMember" enctype="multipart/form-data">
      <div class="input-group">
        ...
        <input type="text" class="form-control required" placeholder="아이디" v-model="member.id" />
        <span>{{ message }}</span>
      </div>
      <div class="input-group">
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control required" placeholder="이름" v-model="member.name" />
      </div>
      <div class="input-group">
      ...
      <div class="input-groupt" v-if="imageSrc != ''">
